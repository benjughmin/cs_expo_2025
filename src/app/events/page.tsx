  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-900 via-purple-800 to-black">
      ...
      <Hero
        ...
        tabs={["CS EXPO DAY 1", "CS EXPO DAY 2", "DEV DAY"]}
      />
            ...
            <div className="flex-1 flex items-center gap-8 bg-purple-900/30 p-8 rounded-lg">
              ...
              <div className="text-white">
                ...
                <p className="text-white/80">
                  ...
                  maximus semper. Duis semper nisl hendrerit
                  hendrerit congue. Duis id arcu non ligula maximus
                  semper. Duis semper nisl hendrerit hendrerit congue
                  ligula dignissim.
                </p>
              </div>
            </div>

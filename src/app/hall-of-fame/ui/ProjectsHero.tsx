  ...
  return (
    <>
      <section className="flex h-[110vh] flex-col">
        <div className="flex h-[65%] flex-col items-center justify-center bg-gradient-to-t from-[#AF05C5] from-[0%] via-[#480CA8] via-[20%] to-black to-[80%] text-white">
          <div className="mx-auto flex max-w-6xl translate-y-10 flex-col items-center justify-center px-4 text-center">
            <h1 className="font-regular mb-4 text-4xl leading-[100px] md:text-8xl lg:text-[128px]">
              {pageTitle}
            </h1>
            <p className="text-[14px] leading-[20px] font-light md:text-base lg:text-lg">
              {pageDesc}
            </p>
          </div>
        </div>
